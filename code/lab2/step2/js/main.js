...
async function setupScene() {
  ...
  let vertSource = await loadNetworkResourceAsText('../../shared/resources/shaders/verts/lab2_2.vert');
  let fragSource = await loadNetworkResourceAsText('../../shared/resources/shaders/frags/lab2_2.frag');
...
function initializeMyObject(vertSource, fragSource, objData) {
  ...
  */
  ...
  myDrawable.uniformLocations = myShader.getUniformLocations(['uModelViewMatrix', 'uProjectionMatrix', 'Ka', 'Kd', 'Ks', 'shininessVal', 'ambientColor', 'diffuseColor', 'specularColor' ]);
