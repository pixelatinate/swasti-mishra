...
async function setupScene() {
  ...
  let vertSource = await loadNetworkResourceAsText('../../shared/resources/shaders/verts/lab3_3.vert');
  let fragSource = await loadNetworkResourceAsText('../../shared/resources/shaders/frags/lab3_3.frag');
  ...
  var image = new Image();
  image.src = "../../shared/resources/textures/transparent/sd_power_t.png";
