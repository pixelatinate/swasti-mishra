...
async function setupScene() {
  ...
  let vertSource = await loadNetworkResourceAsText('../../shared/resources/shaders/verts/lab3_1.vert');
  let fragSource = await loadNetworkResourceAsText('../../shared/resources/shaders/frags/lab3_1.frag');
  ...
  var image = new Image();
  image.src = "../../shared/resources/textures/transparent/sd_ut_system_logo.png";
...
function initializeMyObject(vertSource, fragSource, objData) {
  ...
  */
  ...
  myDrawable.uniformLocations = myShader.getUniformLocations(['uModelViewMatrix', 'uProjectionMatrix', 'Ka', 'Kd', 'Ks', 'shininessVal', 'ambientColor', 'diffuseColor', 'specularColor', 'minAndMax' ]);
